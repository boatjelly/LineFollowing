...
const unsigned char TRN = 120; // threshold for both motors using battery packs
// New variables
...
const unsigned char RWHL = 255;  // Turns right (controls R wheel), use when left detects black
